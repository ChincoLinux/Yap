...
- **Todo cambio entra vía PR aprobado** — sin excepciones. No se permite push directo a `main`, `lowmem` o `ultra-lowmem`, ni siquiera a admins. El bypass de admin está prohibido por doctrina del repositorio.
